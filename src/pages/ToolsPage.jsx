...
const tools = [
  ...
  },
  {
    ...
    tagline: 'Auto-Fill Government Forms',
    description: 'Save your profile once, auto-fill any government form. Supports DS-11, SS-5, W-4, and more.',
    status: 'New',
    icon: FileText,
    link: '/forms',
    features: ['Profile storage', '6+ forms', 'PDF export', 'Local privacy'],
  },
  {
    id: 'notifications',
    name: 'Notification Center',
    tagline: 'Never Miss a Deadline',
    description: 'Set reminders for license renewals, tax payments, registration deadlines, and more.',
    status: 'New',
    icon: Bell,
    link: '/notifications',
    features: ['Custom reminders', 'Priority levels', 'Email alerts', 'Categories'],
  },
  {
    id: 'achievements',
    name: 'Achievements',
    tagline: 'Gamified Progress',
    description: 'Earn points and badges for completing processes. Track streaks and unlock rewards.',
    status: 'New',
    icon: Sparkles,
    link: '/achievements',
    features: ['20+ badges', 'Point system', 'Streaks', 'Rewards'],
  },
  {
    id: 'help',
    name: 'Help Center',
    tagline: 'Knowledge Base',
    description: 'Searchable FAQ and help articles. Find answers to common questions about CLEAR.',
    status: 'New',
    icon: Search,
    link: '/help',
    features: ['Searchable FAQ', '25+ articles', 'Categories', 'Contact support'],
  },
  {
    id: 'integrations',
    name: 'Integrations',
    tagline: 'Connect Your Tools',
    description: 'Connect CLEAR to Google Calendar, Dropbox, Slack, Zapier, and more.',
    status: 'New',
    icon: Code,
    link: '/integrations',
    features: ['10+ integrations', 'Calendar sync', 'Cloud storage', 'Automation'],
  },
  {
    id: 'regwatch',
    name: 'RegWatch',
